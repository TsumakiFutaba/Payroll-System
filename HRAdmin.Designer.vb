...
Partial Class HRAdmin
    ...
    Private Sub InitializeComponent()
        ...
        btnPayroll.Font = New Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point)
        btnPayroll.ForeColor = Color.FromArgb(CByte(204), CByte(204), CByte(204))
        btnPayroll.Image = My.Resources.Resources.paper_payroll
        btnPayroll.ImageAlign = ContentAlignment.MiddleLeft
        btnPayroll.Location = New Point(0, 249)
        btnPayroll.Name = "btnPayroll"
        btnPayroll.Size = New Size(203, 34)
        ...
        pnlButtons1.Controls.Add(Button1)
        ...
        Button1.Image = My.Resources.Resources.icons8_home_24
        ...
        btnDeductions.Font = New Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point)
        btnDeductions.ForeColor = Color.FromArgb(CByte(204), CByte(204), CByte(204))
        btnDeductions.Image = My.Resources.Resources.indeterminate_checkbox_deduction
        btnDeductions.ImageAlign = ContentAlignment.MiddleLeft
        btnDeductions.Location = New Point(-3, 164)
        btnDeductions.Name = "btnDeductions"
        btnDeductions.Size = New Size(203, 34)
        btnDeductions.TabIndex = 5
        btnDeductions.Text = "Deductions"
        btnDeductions.UseVisualStyleBackColor = True
        ' 
        ' btnEmployee
        ' 
        btnEmployee.FlatAppearance.BorderSize = 0
        btnEmployee.FlatStyle = FlatStyle.Flat
        btnEmployee.Font = New Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point)
        btnEmployee.ForeColor = Color.FromArgb(CByte(204), CByte(204), CByte(204))
        btnEmployee.Image = My.Resources.Resources.icons8_users_24
        btnEmployee.ImageAlign = ContentAlignment.MiddleLeft
        btnEmployee.Location = New Point(-3, 127)
        btnEmployee.Name = "btnEmployee"
        btnEmployee.Size = New Size(203, 33)
        ...
        btnAttendance.Image = My.Resources.Resources.icons8_clipboard_checklist_24
        btnAttendance.ImageAlign = ContentAlignment.MiddleLeft
        btnAttendance.Location = New Point(-3, 88)
        btnAttendance.Name = "btnAttendance"
        btnAttendance.Size = New Size(203, 34)
        btnAttendance.TabIndex = 3
        btnAttendance.Text = "Attendances"
        ...
        lReports.Size = New Size(103, 25)
        lReports.TabIndex = 0
        lReports.Text = "HR Admin"
        ' 
        ' pnlLogo
        ' 
