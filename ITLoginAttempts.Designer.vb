...
Partial Class ITLoginAttempts
    ...
    Private Sub InitializeComponent()
        ...
        lblOverview.Size = New Size(290, 47)
        lblOverview.TabIndex = 8
        lblOverview.Text = "Log-in Attempts"
        ' 
        ' Panel6
        ' 
        ...
        ' Column3
        ' 
        Column3.HeaderText = "Number of Attempts"
        ...
        Name = "ITLoginAttempts"
        Text = "ITLoginAttempts"
